...
ex16a_analysis ='''
----------------------------------------------------------------------------
ANALYSIS: 0.12 some, but not much correlation at all'
----------------------------------------------------------------------------'''

ex16b_sol_orig = df[COL_NUMBER_OF_CREDIT_PROBLEMS].corr(df[COL_BANKRUPTCIES])
ex16b_sol_orig_analysis = '''
----------------------------------------------------------------------------
ANALYSIS:  Shows no correlation at all... which seems completely against
common sense
...
ex16b_sol_fixed_analysis='''
----------------------------------------------------------------------------
ANALYSIS: Now ~0.75 very strong correlation as expected
----------------------------------------------------------------------------'''